  ...
  return knex('listings').del()
    .then(function () {
      ...
      return knex('listings').insert([
        {id: 1, name: '2019 MacBook Pro', description: 'A great computer that will help you achieve your goals.', exchange_method: "I'll cover the costs of 2-day shipping it to you anywhere in the United States", price_per_day_in_dollars: 20, is_currently_available: true, owner_id: 3},
